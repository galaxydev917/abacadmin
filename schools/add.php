...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet light portlet-fit portlet-form bordered">
                                    ...
                                    <div class="portlet-body">
                                        <!-- BEGIN FORM-->
                                        <form action="#" id="add_school" method="post" class="form-horizontal" enctype="multipart/form-data">
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label col-md-3">School Address
                                                        <span class="required"> * </span>
                                                    </label>
                                                    <div class="col-md-4">
                                                        <input type="text" name="address" id="address" data-required="1" class="form-control" /> </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-md-3">School Director
                                                        <span class="required"> * </span>
                                                    </label>
                                                    <div class="col-md-4">
                                                        <input type="text" name="director" id="director" data-required="1" class="form-control" /> </div>
                                                </div>
        ...
        <script>
            function addAction(){
                var objForm = document.getElementById("add_school");
