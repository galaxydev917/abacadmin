                                                    ...
                                                    <div class="col-md-4">
                                                        <select class="form-control select2me" name="category">
                                                            ...
                                                            <?php 
                                                                ...
                                                                $fs = new Firestore('categories');
                                                                $documents = $fs->getDocuments();
                                                                foreach ($documents as $document) {
                                                                    $doc = $document->data();
                                                                    $id = $document->id();
                                                            ?>
                                                            <option value="<?php echo $id; ?>"><?php echo $doc['name']; ?></option>
                                                                <?php }?>
                                                        </select>
                                                    </div>
                                                </div>   
                                                <div class="form-group">
                                                    <label class="control-label col-md-3">School
                                                        <span class="required"> * </span>
                                                    </label>
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="mt-checkbox-list" data-error-container="#form_2_services_error">
                                                            <label class="mt-checkbox">
                                                                <input type="checkbox" value="1" name="meal" /> Meal
                                                                <span></span>
                                                            </label>
                                                        </div>
